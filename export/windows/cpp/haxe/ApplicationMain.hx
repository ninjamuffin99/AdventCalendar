...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("NInjaMuffin99", "AdventCalender", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "AdventCalender";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "AdventCalender", null, { width: 960, height: 540 });
