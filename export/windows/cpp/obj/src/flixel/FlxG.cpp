...
HXLINE( 312)		::flixel::FlxG_obj::scaleMode->onMeasure(Width,Height);
            	}
...
HXLINE( 322)		::openfl::_legacy::Lib_obj::get_current()->get_stage()->resize(Width,Height);
            	}
...
HXLINE( 340)		::flixel::FlxG_obj::game->_resetGame = true;
            	}
...
HXLINE( 349)		if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
...
HXLINE( 359)		 ::flixel::FlxState nextState = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 359)		if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 359)			::flixel::FlxG_obj::game->_requestedState = nextState;
            		}
            	}
...
HXLINE( 419)		return ::flixel::util::FlxCollision_obj::pixelPerfectCheck(Sprite1,Sprite2,AlphaTolerance,Camera);
            	}
...
HXLINE( 443)		return ::flixel::FlxG_obj::overlap(ObjectOrGroup1,ObjectOrGroup2,NotifyCallback,::flixel::FlxObject_obj::separate_dyn());
            	}
...
HXLINE( 579)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::inputs;
HXDLIN( 579)		::flixel::FlxG_obj::touches = _hx_tmp2->add_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager_obj::__alloc( HX_CTX ));
HXLINE( 583)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::inputs;
HXDLIN( 583)		::flixel::FlxG_obj::gamepads = _hx_tmp3->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__alloc( HX_CTX ));
...
HXLINE( 633)		::flixel::FlxG_obj::renderMethod = ::flixel::FlxRenderMethod_obj::DRAW_TILES_dyn();
...
HXLINE( 699)			::flixel::FlxG_obj::log->advanced((HX_("FlxG.framerate: the game's framerate shouldn't be smaller than the flash framerate,",78,cb,ed,38) + HX_(" since it can stop your game from updating.",d2,3f,a2,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
...
HXLINE( 716)			::flixel::FlxG_obj::log->advanced((HX_("FlxG.drawFramerate: the update framerate shouldn't be smaller than the draw framerate,",b9,9c,3b,de) + HX_(" since it can stop your game from updating.",d2,3f,a2,00)),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
            		}
HXLINE( 719)		::flixel::FlxG_obj::drawFramerate = ::Std_obj::_hx_int(::Math_obj::abs(Framerate));
HXLINE( 721)		if (hx::IsNotNull( ::flixel::FlxG_obj::game->get_stage() )) {
HXLINE( 722)			::flixel::FlxG_obj::game->get_stage()->set_frameRate(::flixel::FlxG_obj::drawFramerate);
            		}
...
HXLINE( 734)		if (hx::IsNotEq( ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_displayState(),::openfl::_legacy::display::StageDisplayState_obj::FULL_SCREEN_dyn() )) {
HXLINE( 735)			return hx::IsEq( ::openfl::_legacy::Lib_obj::get_current()->get_stage()->get_displayState(),::openfl::_legacy::display::StageDisplayState_obj::FULL_SCREEN_INTERACTIVE_dyn() );
            		}
            		else {
...
HXLINE( 740)		 ::openfl::_legacy::display::StageDisplayState _hx_tmp;
HXDLIN( 740)		if (Value) {
HXLINE( 740)			_hx_tmp = ::openfl::_legacy::display::StageDisplayState_obj::FULL_SCREEN_dyn();
            		}
            		else {
HXLINE( 740)			_hx_tmp = ::openfl::_legacy::display::StageDisplayState_obj::NORMAL_dyn();
            		}
HXDLIN( 740)		::openfl::_legacy::Lib_obj::get_current()->get_stage()->set_displayState(_hx_tmp);
...
HXLINE( 746)		return ::openfl::_legacy::Lib_obj::get_current()->get_stage();
            	}
...
HXLINE( 751)		return ::flixel::FlxG_obj::game->_state;
            	}
...
HXLINE(  71)		autoPause = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_76_boot)
HXLINE(  76)		fixedTimestep = true;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_80_boot)
HXLINE(  80)		timeScale = ((Float)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_86_boot)
HXLINE(  86)		worldDivisions = (int)6;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_97_boot)
HXLINE(  97)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__alloc( HX_CTX ,(int)4,(int)5,(int)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_143_boot)
HXLINE( 143)		elapsed = ((Float)0);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_150_boot)
HXLINE( 150)		maxElapsed = ((Float)0.1);
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_165_boot)
HXLINE( 165)		scaleMode = ( ( ::flixel::_hx_system::scaleModes::BaseScaleMode)( ::flixel::_hx_system::scaleModes::RatioScaleMode_obj::__alloc( HX_CTX ,null())) );
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
            			HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_175_boot)
HXLINE( 175)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
...
HXDLIN( 175)			return rect;
            	...
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_175_boot)
HXLINE( 175)		worldBounds =  ::Dynamic(new _hx_Closure_0())();
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_181_boot)
HXLINE( 181)		save =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_187_boot)
HXLINE( 187)		random =  ::flixel::math::FlxRandom_obj::__alloc( HX_CTX ,null());
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_208_boot)
HXLINE( 208)		swipes = ::Array_obj< ::Dynamic>::__new(0);
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_250_boot)
HXLINE( 250)		inputs =  ::flixel::_hx_system::frontEnds::InputFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_254_boot)
HXLINE( 254)		console =  ::flixel::_hx_system::frontEnds::ConsoleFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_258_boot)
HXLINE( 258)		log =  ::flixel::_hx_system::frontEnds::LogFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_262_boot)
HXLINE( 262)		bitmapLog =  ::flixel::_hx_system::frontEnds::BitmapLogFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_266_boot)
HXLINE( 266)		watch =  ::flixel::_hx_system::frontEnds::WatchFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_271_boot)
HXLINE( 271)		debugger =  ::flixel::_hx_system::frontEnds::DebuggerFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_281_boot)
HXLINE( 281)		bitmap =  ::flixel::_hx_system::frontEnds::BitmapFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_285_boot)
HXLINE( 285)		cameras =  ::flixel::_hx_system::frontEnds::CameraFrontEnd_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_291_boot)
HXLINE( 291)		initialWidth = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_292_boot)
HXLINE( 292)		initialHeight = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_293_boot)
HXLINE( 293)		initialZoom = ((Float)0);
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_305_boot)
HXLINE( 305)		signals =  ::flixel::_hx_system::frontEnds::SignalFrontEnd_obj::__alloc( HX_CTX );
            	}
}
