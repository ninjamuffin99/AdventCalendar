...
HXLINE( 211)			 ::flixel::input::FlxInput key = _g1->__get(_g).StaticCast<  ::flixel::input::FlxInput >();
...
HXLINE( 352)		return this->_keyListMap->get(KeyCode).StaticCast<  ::flixel::input::FlxInput >();
            	}
