...
HXLINE(  17)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick = this->gamepad->mapping->getAnalogStick((int)19);
HXDLIN(  17)		if (hx::IsNull( stick )) {
HXLINE(  17)			return false;
            		}
            		else {
HXLINE(  17)			int RawID = stick->x;
...
HXLINE(  18)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick = this->gamepad->mapping->getAnalogStick((int)19);
HXDLIN(  18)		if (hx::IsNull( stick )) {
HXLINE(  18)			return false;
            		}
            		else {
HXLINE(  18)			int RawID = stick->y;
...
HXLINE(  20)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick = this->gamepad->mapping->getAnalogStick((int)20);
HXDLIN(  20)		if (hx::IsNull( stick )) {
HXLINE(  20)			return false;
            		}
            		else {
HXLINE(  20)			int RawID = stick->x;
...
HXLINE(  21)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick = this->gamepad->mapping->getAnalogStick((int)20);
HXDLIN(  21)		if (hx::IsNull( stick )) {
HXLINE(  21)			return false;
            		}
            		else {
HXLINE(  21)			int RawID = stick->y;
