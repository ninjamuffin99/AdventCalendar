...
HXLINE( 298)			 ::flixel::input::gamepad::FlxGamepad gamepad = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
...
HXLINE( 408)		int _g = ::Math_obj::round(id);
...
HXLINE( 522)		int event1 = event->device;
...
HXLINE( 536)			 ::flixel::input::gamepad::FlxGamepad gamepad = _g1->__get(_g).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
