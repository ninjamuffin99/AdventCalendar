...
HXLINE( 381)			_hx_tmp2 = ( (bool)(this->currentInput->__Field(HX_("get_justReleased",92,07,fa,6a),hx::paccDynamic)()) );
            		}
            		else {
...
HXLINE( 387)					_hx_tmp3 = ( (bool)(this->currentInput->__Field(HX_("get_justReleased",92,07,fa,6a),hx::paccDynamic)()) );
            				}
            				else {
...
HXLINE( 453)		if (( (bool)(input->__Field(HX_("get_justPressed",6d,c5,88,b3),hx::paccDynamic)()) )) {
