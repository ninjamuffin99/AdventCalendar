...
HXLINE(  16)		super::__construct(options,manager);
            	}
...
HXDLIN(  45)		if ((this->executions > (int)0)) {
...
HXLINE(  54)			if ((this->_propertyInfos->length == (int)0)) {
...
HXLINE(  60)					 ::Dynamic info1 =  ::Dynamic(info->__Field(HX_("object",bf,7e,3f,15),hx::paccDynamic));
HXDLIN(  60)					::String info2 = ( (::String)(info->__Field(HX_("field",ba,94,93,00),hx::paccDynamic)) );
HXDLIN(  60)					Float info3 = ( (Float)(info->__Field(HX_("startValue",af,57,cf,4d),hx::paccDynamic)) );
HXDLIN(  60)					::Reflect_obj::setProperty(info1,info2,(info3 + (( (Float)(info->__Field(HX_("range",bd,a5,1f,e4),hx::paccDynamic)) ) * this->scale)));
            				}
            			}
            		}
            	}
...
HXLINE(  70)			HX_STACK_DO_THROW(HX_("Unsupported properties container - use an object containing key/value pairs.",0b,19,89,5b));
            		}
HXLINE(  72)		{
...
HXDLIN(  77)						_g1 = (_g1 + (int)1);
HXLINE(  79)						target = ::Reflect_obj::getProperty(target,component);
HXLINE(  80)						if (!(::Reflect_obj::isObject(target))) {
HXLINE(  81)							HX_STACK_DO_THROW(((((HX_("The object does not have the property \"",5c,e6,6d,12) + component) + HX_("\" in \"",e5,cf,af,4a)) + fieldPath) + HX_("\"",22,00,00,00)));
            						}
            					}
            				}
HXLINE(  84)				if (hx::IsNull( ::Reflect_obj::getProperty(target,field) )) {
HXLINE(  85)					HX_STACK_DO_THROW(((HX_("The object does not have the property \"",5c,e6,6d,12) + field) + HX_("\"",22,00,00,00)));
            				}
HXLINE(  87)				 ::Dynamic value = ::Reflect_obj::getProperty(target,field);
HXLINE(  88)				if (::Math_obj::isNaN(( (Float)(value) ))) {
HXLINE(  89)					HX_STACK_DO_THROW(((HX_("The property \"",06,e3,80,a4) + field) + HX_("\" is not numeric.",66,4f,2a,cf)));
            				}
...
HXLINE(  92)				this->_propertyInfos->push( ::Dynamic(hx::Anon_obj::Create(4)
            					->setFixed(0,HX_("range",bd,a5,1f,e4),(targetValue - value))
