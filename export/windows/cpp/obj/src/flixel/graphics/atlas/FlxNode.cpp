...
HXLINE( 145)			_hx_tmp = hx::IsNull( this->left );
            		}
            		else {
HXLINE( 145)			_hx_tmp = false;
            		}
HXDLIN( 145)		if (_hx_tmp) {
HXLINE( 145)			return hx::IsNull( this->right );
            		}
            		else {
...
HXLINE( 150)		return ::Std_obj::_hx_int(this->rect->x);
            	}
...
HXLINE( 155)		return ::Std_obj::_hx_int(this->rect->y);
            	}
...
HXLINE( 160)		return ::Std_obj::_hx_int(this->rect->width);
            	}
...
HXLINE( 171)		return ::Std_obj::_hx_int(this->rect->height);
            	}
