...
HXLINE( 557)			_hx_tmp = (newHeight > ::Std_obj::_hx_int(this->root->rect->height));
            		}
            		else {
...
HXLINE( 823)			if (hx::IsNotNull( this->_graphic )) {
HXLINE( 823)				_hx_tmp = (this->_graphic->get_useCount() <= (int)0);
            			}
            			else {
...
HXLINE( 896)		if (hx::IsNotNull( node )) {
