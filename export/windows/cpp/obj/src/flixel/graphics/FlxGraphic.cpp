...
HXLINE( 411)			if (hx::IsNull( this->assetsClass )) {
HXLINE( 411)				_hx_tmp = hx::IsNotNull( this->assetsKey );
            			}
            			else {
...
HXLINE( 499)		if (hx::IsNotNull( collection->type )) {
...
HXLINE( 582)		if (hx::IsNull( this->assetsClass )) {
HXLINE( 582)			return hx::IsNotNull( this->assetsKey );
            		}
            		else {
...
HXLINE( 587)		return this->_useCount;
            	}
...
HXLINE( 621)		return ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(hx::ObjectPtr<OBJ_>(this),null());
            	}
...
HXLINE( 180)		return ::flixel::graphics::FlxGraphic_obj::fromGraphic(Source->parent,Unique,Key);
            	}
...
HXLINE( 238)		if (Unique) {
HXLINE( 238)			return Bitmap->clone();
            		}
            		else {
HXLINE( 238)			return Bitmap;
            		}
...
HXLINE(  29)		defaultPersist = false;
            	}
}
