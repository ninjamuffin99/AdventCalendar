...
HXLINE(  60)			 ::openfl::_legacy::display::Graphics gfx = camera->debugLayer->get_graphics();
HXLINE(  61)			gfx->lineStyle((int)1,(int)-16776961,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(  62)			gfx->drawTriangles(this->vertices,this->indices,null(),null(),null(),null());
            		}
...
HXLINE( 283)		return ::Std_obj::_hx_int(((Float)this->vertices->length / (Float)(int)2));
            	}


int FlxDrawTrianglesItem_obj::get_numTriangles(){
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_288_get_numTriangles)
HXLINE( 288)		return ::Std_obj::_hx_int(((Float)this->indices->length / (Float)(int)3));
            	}
...
HXLINE(  22)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN(  22)			return point;
            	...
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_22_boot)
HXLINE(  22)		point =  ::Dynamic(new _hx_Closure_0())();
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
...
HXDLIN(  23)			return rect;
            	...
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_23_boot)
HXLINE(  23)		rect =  ::Dynamic(new _hx_Closure_0())();
            	}
}
