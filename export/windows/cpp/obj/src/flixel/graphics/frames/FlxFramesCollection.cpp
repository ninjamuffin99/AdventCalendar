...
HXLINE( 112)		return this->frames->indexOf(frame,null());
            	}
...
HXLINE( 241)		HX_STACK_DO_THROW(HX_("To be overriden in subclasses",8b,78,89,60));
...
HXLINE( 254)		return this->frames->length;
            	}
