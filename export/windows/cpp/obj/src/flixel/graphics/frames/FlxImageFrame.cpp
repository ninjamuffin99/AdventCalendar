...
HXLINE( 211)		 ::flixel::math::FlxRect rect1 = this->get_frame()->frame;
...
HXLINE( 211)			result2 = (::Math_obj::abs((rect->y - rect1->y)) <= ((Float)0.0000001));
            		}
            		else {
HXLINE( 211)			result2 = false;
            		}
HXDLIN( 211)		if (result2) {
HXLINE( 211)			result1 = (::Math_obj::abs((rect->width - rect1->width)) <= ((Float)0.0000001));
            		}
            		else {
HXLINE( 211)			result1 = false;
            		}
HXDLIN( 211)		if (result1) {
HXLINE( 211)			result = (::Math_obj::abs((rect->height - rect1->height)) <= ((Float)0.0000001));
            		}
            		else {
HXLINE( 211)			result = false;
            		}
HXDLIN( 211)		if (rect1->_weak) {
HXLINE( 211)			if (!(rect1->_inPool)) {
...
HXLINE( 211)			 ::flixel::math::FlxPoint point = this->border;
HXDLIN( 211)			bool result3;
HXDLIN( 211)			if ((::Math_obj::abs((border->x - point->x)) <= ((Float)0.0000001))) {
HXLINE( 211)				result3 = (::Math_obj::abs((border->y - point->y)) <= ((Float)0.0000001));
            			}
            			else {
HXLINE( 211)				result3 = false;
            			}
