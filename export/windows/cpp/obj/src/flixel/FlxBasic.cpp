...
HXLINE( 111)		::flixel::FlxBasic_obj::activeCount++;
            	}
...
HXLINE( 122)		::flixel::FlxBasic_obj::visibleCount++;
            	}
...
HXLINE( 138)		return (this->visible = Value);
            	}
...
HXLINE( 144)		return (this->active = Value);
            	}
...
HXLINE( 150)		return (this->exists = Value);
            	}
...
HXLINE( 156)		return (this->alive = Value);
            	}
...
HXLINE( 162)			_hx_tmp = (this->_cameras->length == (int)0);
            		}
            		else {
HXLINE( 162)			_hx_tmp = true;
            		}
HXDLIN( 162)		if (_hx_tmp) {
HXLINE( 162)			return ::flixel::FlxCamera_obj::defaultCameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
            		else {
HXLINE( 162)			return this->_cameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
...
HXLINE( 178)			return ::flixel::FlxCamera_obj::defaultCameras;
            		}
            		else {
HXLINE( 178)			return this->_cameras;
            		}
...
HXLINE( 184)		return (this->_cameras = Value);
            	}
