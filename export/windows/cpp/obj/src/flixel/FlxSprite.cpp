...
HXLINE( 312)		return  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->loadGraphicFromSprite(hx::ObjectPtr<OBJ_>(this));
            	}
...
HXLINE( 635)		if (hx::IsNull( this->_frame )) {
...
HXLINE( 769)		if (::flixel::FlxG_obj::renderBlit) {
...
HXLINE( 806)		 ::flixel::math::FlxPoint _hx_tmp = this->origin;
...
HXLINE(1119)		if (hx::IsNull( this->graphic )) {
...
HXLINE(1230)		if (this->_angleChanged) {
