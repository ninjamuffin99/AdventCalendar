...
HXLINE( 156)		Float _hx_tmp = (this->x * v->x);
...
HXLINE( 179)		Float _hx_tmp = (this->x * v->x);
...
HXLINE( 190)		Float _hx_tmp = (this->x * v->y);
...
HXLINE( 201)		Float _hx_tmp = (this->x * v->y);
...
HXLINE( 240)		Float _hx_tmp = (this->x * this->x);
...
HXLINE( 269)		Float rads = (degs * ((Float)::Math_obj::PI / (Float)(int)180));
...
HXLINE( 325)		 ::flixel::math::FlxVector _this = this->clone(null());
HXDLIN( 325)		{
HXLINE( 325)			 ::flixel::math::FlxVector _g = _this;
HXDLIN( 325)			_g->set_x((_g->x * (int)-1));
            		}
HXDLIN( 325)		{
HXLINE( 325)			 ::flixel::math::FlxVector _g1 = _this;
...
HXLINE( 373)		Float _hx_tmp = (this->y * v->x);
...
HXLINE( 464)		Float _hx_tmp = (this->x * v->x);
...
HXLINE( 475)		Float _hx_tmp = (this->x * v->x);
...
HXLINE( 499)		Float dx = (v->x - this->x);
...
HXLINE( 592)		Float _hx_tmp = (this->x * this->x);
...
HXLINE( 608)		Float _hx_tmp = (this->x * this->x);
