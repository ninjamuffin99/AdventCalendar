...
HXLINE( 268)		if (hx::IsNotNull( this->_sprite->frames )) {
...
HXLINE( 320)		if (hx::IsNotNull( this->_sprite->frames )) {
...
HXLINE( 376)		if (hx::IsNotNull( this->_sprite->frames )) {
...
HXLINE( 457)		if (hx::IsNotNull( this->_sprite->frames )) {
...
HXLINE( 613)		if (hx::IsNotNull( this->_curAnim )) {
...
HXLINE( 643)		if (hx::IsNotNull( this->callback )) {
...
HXLINE( 654)		if (hx::IsNotNull( this->finishCallback )) {
...
HXLINE( 662)			::String frameName = FrameNames->__get(_g);
...
HXLINE( 674)		int _g = (int)0;
HXDLIN( 674)		while((_g < Indices->length)){
HXLINE( 674)			::String index = Indices->__get(_g);
...
HXLINE( 687)		int _g = (int)0;
HXDLIN( 687)		while((_g < Indices->length)){
HXLINE( 687)			int index = Indices->__get(_g);
...
HXLINE( 712)		int _g = (int)0;
HXDLIN( 712)		::Array< ::Dynamic> _g1 = this->_sprite->frames->frames;
HXDLIN( 712)		while((_g < _g1->length)){
HXLINE( 712)			 ::flixel::graphics::frames::FlxFrame frame = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
