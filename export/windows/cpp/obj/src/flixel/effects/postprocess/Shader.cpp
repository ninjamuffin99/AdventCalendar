...
HXLINE(  71)		return ( (int)(::openfl::_legacy::gl::GL_obj::lime_gl_get_attrib_location(this->program->id,a)) );
            	}
...
HXLINE(  81)		return ::openfl::_legacy::gl::GL_obj::lime_gl_get_uniform_location(this->program->id,u);
            	}
...
HXLINE(  89)		 ::openfl::_legacy::gl::GLProgram program = this->program;
HXDLIN(  89)		 ::Dynamic _hx_tmp;
HXDLIN(  89)		if (hx::IsNull( program )) {
HXLINE(  89)			_hx_tmp = null();
            		}
            		else {
HXLINE(  89)			_hx_tmp = program->id;
            		}
