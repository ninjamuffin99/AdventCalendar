...
HXLINE(  94)		if (this->uniforms->exists(uniform)) {
...
HXLINE( 183)		 ::flixel::effects::postprocess::PostProcess _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 275)		return ::Array_obj< Float >::fromData( _hx_array_data_9b9fdb32_12,24);
            	}
