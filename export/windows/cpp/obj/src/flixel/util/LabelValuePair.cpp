...
HXLINE( 669)		::flixel::util::LabelValuePair_obj::_pool->put(hx::ObjectPtr<OBJ_>(this));
            	}
...
HXLINE( 654)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
...
HXLINE( 650)		_pool =  ::flixel::util::FlxPool_flixel_util_LabelValuePair_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::util::LabelValuePair >());
            	}
}
