...
HXLINE( 288)		this->_timers->push(Timer);
            	}
...
HXLINE( 300)		::Array< ::Dynamic> array = this->_timers;
HXDLIN( 300)		int index = array->indexOf(Timer,null());
HXDLIN( 300)		if ((index != (int)-1)) {
HXLINE( 300)			array[index] = array->__get((array->length - (int)1)).StaticCast<  ::flixel::util::FlxTimer >();
...
HXLINE( 330)		::flixel::util::FlxArrayUtil_obj::clearArray(this->_timers,null());
            	}
...
HXLINE( 341)			 ::flixel::util::FlxTimer timer = _g1->__get(_g).StaticCast<  ::flixel::util::FlxTimer >();
