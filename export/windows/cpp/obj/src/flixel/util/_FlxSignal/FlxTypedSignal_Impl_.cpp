...
HXLINE(  50)		return  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX );
            	}
...
HXLINE(  56)		return  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            	}
...
HXLINE(  62)		return  ::flixel::util::_FlxSignal::FlxSignal2_obj::__alloc( HX_CTX );
            	}
...
HXLINE(  68)		return  ::flixel::util::_FlxSignal::FlxSignal3_obj::__alloc( HX_CTX );
            	}
...
HXLINE(  74)		return  ::flixel::util::_FlxSignal::FlxSignal4_obj::__alloc( HX_CTX );
            	}
