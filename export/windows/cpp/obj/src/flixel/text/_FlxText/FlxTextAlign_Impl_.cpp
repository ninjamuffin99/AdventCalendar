...
HXLINE(1131)		::String _hx_switch_0 = align;
...
HXLINE(1143)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
...
HXLINE(1116)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1123_boot)
HXLINE(1123)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1125_boot)
HXLINE(1125)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1127_boot)
HXLINE(1127)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
