...
HX_DEFINE_STACK_FRAME(_hx_pos_7f720caa169dc7ad_2010_new,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleX","new",0x582a8c31,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleX.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
HX_LOCAL_STACK_FRAME(_hx_pos_b240d50efc681cc2_1_boot,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleX","boot",0xc5291f41,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleX.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicTransformCursorScaleX_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_7f720caa169dc7ad_2010_new)
HXLINE(2076)		super::__construct(width,height,transparent,fillRGBA,null());
HXLINE(2078)		 ::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorScaleX_obj::resourceName));
...
bool GraphicTransformCursorScaleX_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0cd766e7) {
		...
		return inClassId==(int)0x62fd81d9;
	}
}
...
void GraphicTransformCursorScaleX_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools.GraphicTransformCursorScaleX","\xbf","\x9f","\xaa","\xec");
...
{
{
            	HX_STACKFRAME(&_hx_pos_b240d50efc681cc2_1_boot)
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicTransformCursorScaleX",d8,85,cb,d2);
            	}
}
