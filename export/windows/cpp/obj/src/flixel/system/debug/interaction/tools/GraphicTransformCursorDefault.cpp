...
HX_DEFINE_STACK_FRAME(_hx_pos_f5b8d31505376c09_2010_new,"flixel.system.debug.interaction.tools.GraphicTransformCursorDefault","new",0x26694762,"flixel.system.debug.interaction.tools.GraphicTransformCursorDefault.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
...
void GraphicTransformCursorDefault_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_f5b8d31505376c09_2010_new)
HXLINE(2076)		super::__construct(width,height,transparent,fillRGBA,null());
HXLINE(2078)		 ::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorDefault_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicTransformCursorDefault",37,1e,06,d6);
            	}
}
