...
HXLINE(  53)		 ::flixel::group::FlxTypedGroupIterator member =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,items->members,null());
HXDLIN(  53)		while(member->hasNext()){
HXLINE(  53)			 ::flixel::FlxObject member1 = member->next().StaticCast<  ::flixel::FlxObject >();
...
HXLINE(  73)			 ::flixel::FlxBasic member = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
