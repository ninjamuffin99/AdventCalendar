...
HXLINE(  37)		::String _hx_tmp = this->input->get_text();
...
HXLINE(  44)		return this->input->get_text().length;
            	}
...
HXLINE( 112)		return ::flixel::util::FlxStringUtil_obj::sortAlphabetically(::flixel::_hx_system::debug::console::ConsoleUtil_obj::interp->getGlobals());
            	}
...
HXLINE( 129)		return  ::EReg_obj::__alloc( HX_CTX ,(this->getWordAfterDot(text) + HX_("$",24,00,00,00)),HX_("g",67,00,00,00))->replace(text,selectedItem);
            	}
...
HXLINE( 159)		 ::ValueType _g = ::Type_obj::_hx_typeof(v);
...
HXLINE( 207)		return ( (::String)(::flixel::util::FlxArrayUtil_obj::last( ::EReg_obj::__alloc( HX_CTX ,HX_("([^.a-zA-Z0-9_\\[\\]\"']+)",90,0f,11,57),HX_("g",67,00,00,00))->split(text))) );
            	}
