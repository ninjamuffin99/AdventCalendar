...
HXLINE( 127)			{
HXLINE( 127)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile20 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::input::touch::FlxTouch >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_33,7),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
HXDLIN( 127)				if (hx::IsNotNull( Profile20 )) {
HXLINE( 127)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 127)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile20);
            				}
            			}
HXLINE( 130)			{
HXLINE( 130)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile21 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::input::gamepad::FlxGamepad >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_34,8),null());
HXDLIN( 130)				if (hx::IsNotNull( Profile21 )) {
HXLINE( 130)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 130)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile21);
            				}
            			}
HXLINE( 134)			{
HXLINE( 134)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile22 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::flixel::input::FlxSwipe >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_35,6),null());
HXDLIN( 134)				if (hx::IsNotNull( Profile22 )) {
HXLINE( 134)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 134)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile22);
            				}
            			}
HXLINE( 137)			{
HXLINE( 137)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile23 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::display::DisplayObject >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_36,8),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 137)				if (hx::IsNotNull( Profile23 )) {
HXLINE( 137)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 137)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile23);
            				}
            			}
HXLINE( 138)			{
HXLINE( 138)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile24 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::geom::Point >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxPoint >()));
HXDLIN( 138)				if (hx::IsNotNull( Profile24 )) {
HXLINE( 138)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 138)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile24);
            				}
            			}
HXLINE( 139)			{
HXLINE( 139)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile25 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::geom::Rectangle >(),null(),::Array_obj< ::Dynamic>::__new(1)->init(0,hx::ClassOf< ::flixel::math::FlxRect >()));
HXDLIN( 139)				if (hx::IsNotNull( Profile25 )) {
HXLINE( 139)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 139)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile25);
            				}
            			}
HXLINE( 140)			{
HXLINE( 140)				 ::flixel::_hx_system::debug::watch::TrackerProfile Profile26 =  ::flixel::_hx_system::debug::watch::TrackerProfile_obj::__alloc( HX_CTX ,hx::ClassOf< ::openfl::_legacy::geom::Matrix >(),::Array_obj< ::String >::fromData( _hx_array_data_fdcd68f1_37,6),null());
HXDLIN( 140)				if (hx::IsNotNull( Profile26 )) {
HXLINE( 140)					::flixel::_hx_system::debug::watch::Tracker_obj::initProfiles();
HXDLIN( 140)					::flixel::_hx_system::debug::watch::Tracker_obj::profiles->push(Profile26);
            				}
            			}
            		}
            	}
