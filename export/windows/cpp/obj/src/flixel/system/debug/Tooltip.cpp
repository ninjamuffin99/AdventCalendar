...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Tooltip_obj,init,(void))
 ...
 ::flixel::_hx_system::debug::TooltipOverlay Tooltip_obj::add( ::openfl::_legacy::display::Sprite element,::String text){
...
HXDLIN(  39)			int _g = ::flixel::_hx_system::debug::Tooltip_obj::_tooltips->length;
...
HXLINE(  43)					 ::flixel::_hx_system::debug::TooltipOverlay tooltip = ::flixel::_hx_system::debug::Tooltip_obj::_tooltips->splice(i,(int)1)->__get((int)0).StaticCast<  ::flixel::_hx_system::debug::TooltipOverlay >();
