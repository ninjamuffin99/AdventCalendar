...
HX_DEFINE_STACK_FRAME(_hx_pos_a91c2718299393e7_2010_new,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleY","new",0xeb9120b2,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleY.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
...
void GraphicTransformCursorScaleY_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_a91c2718299393e7_2010_new)
HXLINE(2076)		super::__construct(width,height,transparent,fillRGBA,null());
HXLINE(2078)		 ::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorScaleY_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicTransformCursorScaleY",d9,85,cb,d2);
            	}
}
