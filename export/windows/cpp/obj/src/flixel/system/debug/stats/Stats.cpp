...
HXLINE( 162)			drawMethod = HX_("DrawTiles",c1,12,13,7a);
HXLINE( 170)			drawMethod = ((HX_("\n",0a,00,00,00) + drawMethod) + HX_(":",3a,00,00,00));
            		}
HXLINE( 173)		 ::openfl::_legacy::text::TextField _hx_tmp2 = this->_leftTextField;
...
HXDLIN( 269)			_hx_tmp3->update(((Float)((Float)::openfl::_legacy::_hx_system::System_obj::get_totalMemory() / (Float)(int)1024) / (Float)(int)1000));
...
HXLINE( 329)		 ::openfl::_legacy::text::TextField _hx_tmp = this->_rightTextField;
...
HXLINE( 349)		int _hx_tmp = this->_frameCount;
...
HXLINE( 357)		return ((Float)(this->_currentTime - this->_itvTime) / (Float)(int)1000);
            	}
...
HXLINE( 365)		return ((Float)((Float)::openfl::_legacy::_hx_system::System_obj::get_totalMemory() / (Float)(int)1024) / (Float)(int)1000);
            	}
