...
HX_DEFINE_STACK_FRAME(_hx_pos_92ef7891138c3aa5_2010_new,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleXY","new",0x65042dac,"flixel.system.debug.interaction.tools.GraphicTransformCursorScaleXY.new","openfl/_legacy/Assets.hx",2010,0x9276b055)
...
void GraphicTransformCursorScaleXY_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_92ef7891138c3aa5_2010_new)
HXLINE(2076)		super::__construct(width,height,transparent,fillRGBA,null());
HXLINE(2078)		 ::openfl::_legacy::utils::ByteArray byteArray = ::openfl::_legacy::utils::ByteArray_obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::_hx_system::debug::interaction::tools::GraphicTransformCursorScaleXY_obj::resourceName));
...
HXLINE(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools_GraphicTransformCursorScaleXY",81,97,49,9f);
            	}
}
