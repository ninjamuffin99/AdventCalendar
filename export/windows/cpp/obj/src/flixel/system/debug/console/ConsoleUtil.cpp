...
HXLINE(  62)		 ::flixel::_hx_system::debug::console::_ConsoleUtil::Interp _hx_tmp = ::flixel::_hx_system::debug::console::ConsoleUtil_obj::interp;
...
HXLINE(  72)		return ::flixel::_hx_system::debug::console::ConsoleUtil_obj::interp->expr(expr);
            	}
...
HXLINE(  83)			_hx_tmp = ::Reflect_obj::isObject(AnyObject);
            		}
            		else {
...
HXLINE(  95)		if (::Reflect_obj::isFunction(Function)) {
...
HXLINE( 158)		::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,Text),::flixel::_hx_system::debug::log::LogStyle_obj::CONSOLE,null());
            	}
