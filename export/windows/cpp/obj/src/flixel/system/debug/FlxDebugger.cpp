...
HXLINE( 235)			 ::flixel::_hx_system::debug::Window window = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::Window >();
...
HXLINE( 256)		 ::flixel::_hx_system::debug::FlxDebuggerLayout _g = this->_layout;
...
HXLINE( 469)		this->onMouseFocusLost();
            	}
...
HXLINE( 486)		if (this->_usingSystemCursor) {
...
HXLINE( 498)		::flixel::FlxG_obj::debugger->set_drawDebug(!(::flixel::FlxG_obj::debugger->drawDebug));
            	}
...
HXLINE( 503)		::String prefix = HX_("",00,00,00,00);
...
HXLINE( 503)			prefix = HX_("http://",52,75,cd,5a);
            		}
