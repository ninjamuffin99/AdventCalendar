...
HXLINE( 521)		return (this->_volume * this->_volumeAdjust);
            	}
...
HXLINE( 645)		if (!(this->_alreadyPaused)) {
...
HXLINE( 679)		return hx::IsNotNull( this->_channel );
            	}
...
HXLINE( 684)		return this->_volume;
            	}
...
HXLINE( 710)		return this->_transform->pan;
            	}
...
HXLINE( 715)		return (this->_transform->pan = pan);
            	}
...
HXLINE( 735)		return this->_length;
            	}
