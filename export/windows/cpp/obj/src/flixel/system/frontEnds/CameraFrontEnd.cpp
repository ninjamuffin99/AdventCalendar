...
HXLINE( 122)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 139)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 156)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 174)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 216)		if (::flixel::FlxG_obj::renderTile) {
...
HXLINE( 234)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 276)			 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 284)		if (hx::IsNull( ::flixel::FlxG_obj::camera )) {
