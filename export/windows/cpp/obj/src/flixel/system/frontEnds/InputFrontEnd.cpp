...
HXLINE(  96)			::Dynamic input = _g1->__get(_g);
...
HXLINE( 108)			::Dynamic input = _g1->__get(_g);
...
HXLINE( 117)			::Dynamic input = _g1->__get(_g);
...
HXLINE( 126)			::Dynamic input = _g1->__get(_g);
...
HXLINE( 144)			::Dynamic input = _g1->__get(_g);
