...
HXLINE(  29)		::flixel::FlxG_obj::game->debugger->console->registerFunction(FunctionAlias,Function,null());
            	}
...
HXLINE(  42)		::flixel::FlxG_obj::game->debugger->console->registerObject(ObjectAlias,AnyObject);
            	}
...
HXLINE(  67)		 ::flixel::_hx_system::debug::console::Console _this = ::flixel::FlxG_obj::game->debugger->console;
