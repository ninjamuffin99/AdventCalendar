...
HXLINE(  54)		 ::flixel::_hx_system::debug::FlxDebugger _this = ::flixel::FlxG_obj::game->debugger;
...
HXLINE( 166)		if (!(Value)) {
HXLINE( 168)			::openfl::_legacy::Lib_obj::get_current()->get_stage()->set_focus(null());
