...
HXLINE(  52)		 ::Dynamic key = this->_cache->keys();
...
HXLINE(  68)		 ::Dynamic key = this->_cache->keys();
HXDLIN(  68)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  68)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE(  85)		 ::Dynamic key = this->_cache->keys();
HXDLIN(  85)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  85)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 102)		 ::Dynamic key = this->_cache->keys();
HXDLIN( 102)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 102)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 121)		return hx::IsNotNull( ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(this->_cache,Key)) ) );
            	}
...
HXLINE( 136)		return ::flixel::graphics::FlxGraphic_obj::fromRectangle(Width,Height,Color,Unique,Key);
            	}
...
HXLINE( 184)		return this->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
            	}
...
HXLINE( 211)		return ::Type_obj::getClassName(source);
            	}
...
HXLINE( 296)		if (hx::IsNotNull( graphic )) {
HXLINE( 298)			{
...
HXLINE( 309)		if (hx::IsNotNull( key )) {
...
HXLINE( 321)			_hx_tmp1 = (graphic->get_useCount() == (int)0);
            		}
            		else {
HXLINE( 321)			_hx_tmp1 = false;
            		}
HXDLIN( 321)		if (_hx_tmp1) {
HXLINE( 321)			_hx_tmp = !(graphic->persist);
            		}
            		else {
...
HXLINE( 350)		if (hx::IsNotNull( key )) {
...
HXLINE( 384)		 ::Dynamic key = this->_cache->keys();
HXDLIN( 384)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 384)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
...
HXLINE( 397)		return ( (int)(::openfl::_legacy::gl::GL_obj::lime_gl_get_parameter((int)3379)) );
            	}
