...
HXLINE( 170)			::String id = _g1->__get(_g);
...
HXLINE( 213)		return this->load(null(),Volume,Looped,null(),AutoDestroy,true,URL,OnComplete);
            	}
...
HXLINE( 314)			_hx_tmp = this->soundTrayEnabled;
            		}
            		else {
