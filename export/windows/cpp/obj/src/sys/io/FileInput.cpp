...
HX_LOCAL_STACK_FRAME(_hx_pos_4d49a2b5c395a512_47_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","C:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/io/FileInput.hx",47,0x54202051)
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_4d49a2b5c395a512_47_readBytes)
HXLINE(  47)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
