...
HXLINE(  81)		this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,item,this->head);
            	}
...
HXLINE(  90)		if (hx::IsNull( this->head )) {
...
HXLINE( 147)		return  ::haxe::ds::_GenericStack::GenericStackIterator_hscript_Token_obj::__alloc( HX_CTX ,this->head);
            	}
