...
HXLINE(  62)		 ::Dynamic _hx_tmp = hx::ClassOf< ::openfl::_legacy::text::TextField >();
...
HXLINE( 153)		 ::Dynamic _hx_tmp = hx::ClassOf< ::openfl::_legacy::text::TextField >();
...
HXLINE( 234)		 ::Dynamic _hx_tmp = hx::ClassOf< ::openfl::_legacy::text::TextField >();
