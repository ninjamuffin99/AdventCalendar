...
HXLINE(  36)		 ::Dynamic _hx_tmp = hx::ClassOf< ::openfl::_legacy::ui::Multitouch >();
...
HXLINE(  63)		 ::Dynamic _hx_tmp = hx::ClassOf< ::openfl::_legacy::ui::Multitouch >();
...
HXLINE(  73)		lime_stage_get_multitouch_supported = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_stage_get_multitouch_supported",0b,41,ad,e4),(int)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_1c91c4945bff368d_74_boot)
HXLINE(  74)		lime_stage_get_multitouch_active = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_stage_get_multitouch_active",c9,0a,62,87),(int)1);
            	}
{
            	HX_STACKFRAME(&_hx_pos_1c91c4945bff368d_75_boot)
HXLINE(  75)		lime_stage_set_multitouch_active = ::openfl::_legacy::Lib_obj::load(HX_("lime-legacy",c1,7f,b9,87),HX_("lime_legacy_stage_set_multitouch_active",d5,d8,6a,db),(int)2);
            	}
}
