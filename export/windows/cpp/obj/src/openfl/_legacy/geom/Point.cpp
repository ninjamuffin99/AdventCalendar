...
HXLINE(  22)		Float _hx_tmp = (v->x + this->x);
...
HXLINE( 107)		Float _hx_tmp = (this->x - v->x);
...
HXLINE( 128)		Float _hx_tmp = (this->x * this->x);
...
HXLINE(  92)		Float _hx_tmp = (len * ::Math_obj::cos(angle));
