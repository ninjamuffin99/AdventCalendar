...
HXLINE( 194)			::String msg = ((HX_("setChildIndex : object ",93,4a,81,b4) + child->toString()) + HX_(" not found.",39,f7,8e,4f));
HXDLIN( 194)			if (hx::IsEq( child->_hx___parent,hx::ObjectPtr<OBJ_>(this) )) {
HXLINE( 194)				int actualIndex = (int)-1;
HXDLIN( 194)				{
...
HXLINE( 194)			int i1 = firstIndex;
HXDLIN( 194)			while((i1 > index)){
HXLINE( 194)				::Array< ::Dynamic> _hx_tmp = this->_hx___children;
...
HXLINE( 194)				int i2 = firstIndex;
HXDLIN( 194)				while((i2 < index)){
HXLINE( 194)					::Array< ::Dynamic> _hx_tmp2 = this->_hx___children;
...
HXLINE( 217)			 ::openfl::_legacy::display::DisplayObject temp = this->_hx___children->__get(index1).StaticCast<  ::openfl::_legacy::display::DisplayObject >();
