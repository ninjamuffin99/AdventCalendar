...
HXLINE(  31)		Float _hx_tmp = (this->x + a->x);
...
HXLINE(  77)		Float _hx_tmp = (this->y * a->z);
...
HXLINE( 104)		Float _hx_tmp = (this->x * a->x);
...
HXLINE( 187)		Float _hx_tmp = (this->x - a->x);
...
HXLINE( 208)		Float _hx_tmp = (this->x * this->x);
...
HXLINE( 215)		Float _hx_tmp = (this->x * this->x);
