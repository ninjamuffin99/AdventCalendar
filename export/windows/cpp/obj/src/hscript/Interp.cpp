...
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_285_error,"hscript.Interp","error",0xe68736a9,"hscript.Interp.error","hscript/Interp.hx",285,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_293_rethrow,"hscript.Interp","rethrow",0x0be155b4,"hscript.Interp.rethrow","hscript/Interp.hx",293,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_297_resolve,"hscript.Interp","resolve",0x7d16b80d,"hscript.Interp.resolve","hscript/Interp.hx",297,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_307_expr,"hscript.Interp","expr",0xec634974,"hscript.Interp.expr","hscript/Interp.hx",307,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_402_expr,"hscript.Interp","expr",0xec634974,"hscript.Interp.expr","hscript/Interp.hx",402,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_575_doWhileLoop,"hscript.Interp","doWhileLoop",0x813d4b4b,"hscript.Interp.doWhileLoop","hscript/Interp.hx",575,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_592_whileLoop,"hscript.Interp","whileLoop",0xce1b3216,"hscript.Interp.whileLoop","hscript/Interp.hx",592,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_608_makeIterator,"hscript.Interp","makeIterator",0x634d013b,"hscript.Interp.makeIterator","hscript/Interp.hx",608,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_618_forLoop,"hscript.Interp","forLoop",0xdf1ff72e,"hscript.Interp.forLoop","hscript/Interp.hx",618,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_638_isMap,"hscript.Interp","isMap",0x34ae9fb3,"hscript.Interp.isMap","hscript/Interp.hx",638,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_642_getMapValue,"hscript.Interp","getMapValue",0x1594fb8c,"hscript.Interp.getMapValue","hscript/Interp.hx",642,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_646_setMapValue,"hscript.Interp","setMapValue",0x20020298,"hscript.Interp.setMapValue","hscript/Interp.hx",646,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_649_get,"hscript.Interp","get",0xf7e1c137,"hscript.Interp.get","hscript/Interp.hx",649,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_665_set,"hscript.Interp","set",0xf7eadc43,"hscript.Interp.set","hscript/Interp.hx",665,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_672_fcall,"hscript.Interp","fcall",0x6ff6aee5,"hscript.Interp.fcall","hscript/Interp.hx",672,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_676_call,"hscript.Interp","call",0xeaff64dd,"hscript.Interp.call","hscript/Interp.hx",676,0xf078416e)
HX_LOCAL_STACK_FRAME(_hx_pos_f37559d470356c9e_679_cnew,"hscript.Interp","cnew",0xeb093c1c,"hscript.Interp.cnew","hscript/Interp.hx",679,0xf078416e)
namespace hscript{

void Interp_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_53_new)
HXLINE(  53)		 ::hscript::Interp _gthis = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 191)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)1: {
...
HXLINE( 277)		while((this->declared->length > old)){
...
bool rethrow = __o_rethrow.Default(false);
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_285_error)
HXLINE( 285)		if (rethrow) {
HXLINE( 285)			HX_STACK_DO_THROW(e);
            		}
            		else {
HXLINE( 285)			HX_STACK_DO_THROW(e);
            		}
...
void Interp_obj::rethrow( ::Dynamic e){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_293_rethrow)
HXLINE( 293)		HX_STACK_DO_THROW(e);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,rethrow,(void))
 ...
 ::Dynamic Interp_obj::resolve(::String id){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_297_resolve)
HXLINE( 298)		 ::Dynamic l = this->locals->get(id);
HXLINE( 299)		if (hx::IsNotNull( l )) {
HXLINE( 300)			return  ::Dynamic(l->__Field(HX_("r",72,00,00,00),hx::paccDynamic));
            		}
HXLINE( 301)		 ::Dynamic v = this->variables->get(id);
HXLINE( 302)		bool _hx_tmp;
HXDLIN( 302)		if (hx::IsNull( v )) {
HXLINE( 302)			_hx_tmp = !(this->variables->exists(id));
            		}
            		else {
HXLINE( 302)			_hx_tmp = false;
            		}
HXDLIN( 302)		if (_hx_tmp) {
HXLINE( 303)			 ::hscript::Error e = ::hscript::Error_obj::EUnknownVariable(id);
HXDLIN( 303)			HX_STACK_DO_THROW(e);
            		}
HXLINE( 304)		return v;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,resolve,return )
 ...
 ::Dynamic Interp_obj::expr( ::hscript::Expr e){
            	HX_GC_STACKFRAME(&_hx_pos_f37559d470356c9e_307_expr)
HXLINE( 307)		 ::hscript::Interp _gthis = hx::ObjectPtr<OBJ_>(this);
HXLINE( 312)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)0: {
HXLINE( 313)				 ::hscript::Const c = e->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 314)				switch((int)(_hx_getEnumValueIndex(c))){
            					case (int)0: {
HXLINE( 315)						int v = c->_hx_getInt(0);
HXDLIN( 315)						return v;
            					}
            					break;
            					case (int)1: {
HXLINE( 316)						Float f = c->_hx_getFloat(0);
HXDLIN( 316)						return f;
            					}
            					break;
            					case (int)2: {
...
HXDLIN( 317)						return s;
            			...
            			break;
            			case (int)1: {
HXLINE( 322)				::String id = e->_hx_getString(0);
HXLINE( 323)				return this->resolve(id);
            			}
            			break;
            			case (int)2: {
HXLINE( 324)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 324)				::String n = e->_hx_getString(0);
HXLINE( 325)				::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 325)				_hx_tmp->push( ::Dynamic(hx::Anon_obj::Create(2)
            					->setFixed(0,HX_("n",6e,00,00,00),n)
            					->setFixed(1,HX_("old",a7,98,54,00),::haxe::IMap_obj::get(this->locals,n))));
HXLINE( 326)				{
HXLINE( 326)					::Dynamic this1 = this->locals;
HXDLIN( 326)					 ::Dynamic value;
HXDLIN( 326)					if (hx::IsNull( e1 )) {
HXLINE( 326)						value = null();
            					}
            					else {
HXLINE( 326)						value = this->expr(e1);
            					}
HXDLIN( 326)					::haxe::IMap_obj::set(this1,n, ::Dynamic(hx::Anon_obj::Create(1)
...
HXLINE( 327)				return null();
            			...
            			break;
            			case (int)3: {
HXLINE( 328)				 ::hscript::Expr e2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 329)				return this->expr(e2);
            			}
            			break;
            			case (int)4: {
HXLINE( 330)				::Array< ::Dynamic> exprs = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 331)				int old = this->declared->length;
HXLINE( 332)				 ::Dynamic v1 = null();
HXLINE( 333)				{
HXLINE( 333)					int _g = (int)0;
HXDLIN( 333)					while((_g < exprs->length)){
HXLINE( 333)						 ::hscript::Expr e3 = exprs->__get(_g).StaticCast<  ::hscript::Expr >();
HXDLIN( 333)						_g = (_g + (int)1);
HXLINE( 334)						v1 = this->expr(e3);
            					}
            				}
HXLINE( 335)				this->restore(old);
HXLINE( 336)				return v1;
            			}
            			break;
            			case (int)5: {
HXLINE( 337)				::String f1 = e->_hx_getString(1);
HXDLIN( 337)				 ::hscript::Expr e4 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 338)				return this->get(this->expr(e4),f1);
            			}
            			break;
            			case (int)6: {
HXLINE( 339)				 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 339)				 ::hscript::Expr e11 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 339)				::String op = e->_hx_getString(0);
HXLINE( 340)				 ::Dynamic fop = ::haxe::IMap_obj::get(this->binops,op);
HXLINE( 341)				if (hx::IsNull( fop )) {
HXLINE( 341)					 ::hscript::Error e5 = ::hscript::Error_obj::EInvalidOp(op);
HXDLIN( 341)					HX_STACK_DO_THROW(e5);
            				}
HXLINE( 342)				return fop(e11,e21);
            			}
            			break;
            			case (int)7: {
HXLINE( 343)				 ::hscript::Expr e6 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 343)				bool prefix = e->_hx_getBool(1);
HXDLIN( 343)				::String op1 = e->_hx_getString(0);
HXLINE( 344)				::String _hx_switch_0 = op1;
            				if (  (_hx_switch_0==HX_("!",21,00,00,00)) ){
HXLINE( 346)					return hx::IsNotEq( this->expr(e6),true );
HXDLIN( 346)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("++",a0,25,00,00)) ){
HXLINE( 350)					return this->increment(e6,prefix,(int)1);
HXDLIN( 350)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("-",2d,00,00,00)) ){
HXLINE( 348)					return -(this->expr(e6));
HXDLIN( 348)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("--",60,27,00,00)) ){
HXLINE( 352)					return this->increment(e6,prefix,(int)-1);
HXDLIN( 352)					goto _hx_goto_50;
            				}
            				if (  (_hx_switch_0==HX_("~",7e,00,00,00)) ){
HXLINE( 357)					return ~(( (int)(this->expr(e6)) ));
HXDLIN( 357)					goto _hx_goto_50;
            				}
            				/* default */{
HXLINE( 360)					 ::hscript::Error e7 = ::hscript::Error_obj::EInvalidOp(op1);
HXDLIN( 360)					HX_STACK_DO_THROW(e7);
            				}
            				_hx_goto_50:;
            			}
            			break;
            			case (int)8: {
HXLINE( 362)				::Array< ::Dynamic> params = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 362)				 ::hscript::Expr e8 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 363)				::cpp::VirtualArray args = ::cpp::VirtualArray_obj::__new();
HXLINE( 364)				{
HXLINE( 364)					int _g1 = (int)0;
HXDLIN( 364)					while((_g1 < params->length)){
HXLINE( 364)						 ::hscript::Expr p = params->__get(_g1).StaticCast<  ::hscript::Expr >();
HXDLIN( 364)						_g1 = (_g1 + (int)1);
HXLINE( 365)						args->push(this->expr(p));
            					}
            				}
HXLINE( 367)				if ((_hx_getEnumValueIndex(e8) == (int)5)) {
HXLINE( 368)					::String f2 = e8->_hx_getString(1);
HXDLIN( 368)					 ::hscript::Expr e9 = e8->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 369)					 ::Dynamic obj = this->expr(e9);
HXLINE( 370)					if (hx::IsNull( obj )) {
HXLINE( 370)						 ::hscript::Error e10 = ::hscript::Error_obj::EInvalidAccess(f2);
HXDLIN( 370)						HX_STACK_DO_THROW(e10);
            					}
HXLINE( 371)					return this->fcall(obj,f2,args);
            				}
            				else {
HXLINE( 373)					return this->call(null(),this->expr(e8),args);
            				}
            			}
            			break;
            			case (int)9: {
HXLINE( 375)				 ::hscript::Expr e22 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 375)				 ::hscript::Expr e12 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 375)				 ::hscript::Expr econd = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 376)				if (hx::IsEq( this->expr(econd),true )) {
HXLINE( 376)					return this->expr(e12);
            				}
            				else {
HXLINE( 376)					if (hx::IsNull( e22 )) {
HXLINE( 376)						return null();
            					}
            					else {
HXLINE( 376)						return this->expr(e22);
            					}
            				}
            			}
            			break;
            			case (int)10: {
HXLINE( 377)				 ::hscript::Expr e13 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 377)				 ::hscript::Expr econd1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 378)				this->whileLoop(econd1,e13);
HXLINE( 379)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 383)				 ::hscript::Expr e14 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 383)				::String v2 = e->_hx_getString(0);
HXLINE( 384)				this->forLoop(v2,it,e14);
HXLINE( 385)				return null();
            			}
            			break;
            			case (int)12: {
HXLINE( 387)				HX_STACK_DO_THROW(::hscript::_Interp::Stop_obj::SBreak_dyn());
            			}
            			break;
            			case (int)13: {
HXLINE( 389)				HX_STACK_DO_THROW(::hscript::_Interp::Stop_obj::SContinue_dyn());
            			}
            			break;
            			case (int)14: {
            				HX_BEGIN_LOCAL_FUNC_S7(hx::LocalFunc,_hx_Closure_0,::String,name, ::hscript::Expr,fexpr, ::hscript::Interp,_gthis,int,minParams, ::hscript::Interp,me, ::haxe::ds::StringMap,capturedLocals,::Array< ::Dynamic>,params1) HXARGC(1)
            				 ::Dynamic _hx_run(::cpp::VirtualArray args1){
            					HX_STACKFRAME(&_hx_pos_f37559d470356c9e_402_expr)
HXLINE( 403)					if ((args1->get_length() != params1->length)) {
HXLINE( 404)						if ((args1->get_length() < minParams)) {
HXLINE( 405)							::String str = (((HX_("Invalid number of parameters. Got ",cb,2b,d9,b1) + args1->get_length()) + HX_(", required ",ed,0c,66,93)) + minParams);
HXLINE( 406)							if (hx::IsNotNull( name )) {
HXLINE( 406)								str = (str + ((HX_(" for function '",f6,90,ab,a0) + name) + HX_("'",27,00,00,00)));
            							}
HXLINE( 407)							HX_STACK_DO_THROW(str);
            						}
HXLINE( 410)						::cpp::VirtualArray args2 = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 411)						int extraParams = (args1->get_length() - minParams);
HXLINE( 412)						int pos = (int)0;
HXLINE( 413)						{
HXLINE( 413)							int _g3 = (int)0;
HXDLIN( 413)							while((_g3 < params1->length)){
HXLINE( 413)								 ::Dynamic p2 = params1->__get(_g3);
HXDLIN( 413)								_g3 = (_g3 + (int)1);
HXLINE( 414)								if (( (bool)(p2->__Field(HX_("opt",33,9c,54,00),hx::paccDynamic)) )) {
HXLINE( 415)									if ((extraParams > (int)0)) {
HXLINE( 416)										pos = (pos + (int)1);
HXDLIN( 416)										args2->push(args1->__get((pos - (int)1)));
HXLINE( 417)										extraParams = (extraParams - (int)1);
            									}
            									else {
HXLINE( 419)										args2->push(null());
            									}
            								}
            								else {
HXLINE( 421)									pos = (pos + (int)1);
HXDLIN( 421)									args2->push(args1->__get((pos - (int)1)));
            								}
            							}
            						}
HXLINE( 422)						args1 = args2;
            					}
HXLINE( 424)					 ::haxe::ds::StringMap old1 = me->locals;
HXDLIN( 424)					int depth = me->depth;
HXLINE( 425)					me->depth++;
HXLINE( 426)					me->locals = me->duplicate(capturedLocals);
HXLINE( 427)					{
HXLINE( 427)						int _g11 = (int)0;
HXDLIN( 427)						int _g4 = params1->length;
HXDLIN( 427)						while((_g11 < _g4)){
HXLINE( 427)							_g11 = (_g11 + (int)1);
HXDLIN( 427)							int i = (_g11 - (int)1);
HXLINE( 428)							::haxe::IMap_obj::set(me->locals, ::Dynamic(params1->__get(i)->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)), ::Dynamic(hx::Anon_obj::Create(1)
            								->setFixed(0,HX_("r",72,00,00,00),args1->__get(i))));
            						}
            					}
HXLINE( 429)					 ::Dynamic r = null();
HXLINE( 430)					if (_gthis->inTry) {
HXLINE( 431)						try {
            							HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 432)							r = me->exprReturn(fexpr);
            						}
            						catch( ::Dynamic _hx_e){
            							if (_hx_e.IsClass<  ::Dynamic >() ){
            								HX_STACK_BEGIN_CATCH
            								 ::Dynamic e15 = _hx_e;
HXLINE( 434)								me->locals = old1;
HXLINE( 435)								me->depth = depth;
HXLINE( 439)								HX_STACK_DO_THROW(e15);
            							}
            							else {
            								HX_STACK_DO_THROW(_hx_e);
            							}
...
HXLINE( 443)						r = me->exprReturn(fexpr);
            					}
HXLINE( 444)					me->locals = old1;
HXLINE( 445)					me->depth = depth;
HXLINE( 446)					return r;
            				}
            				HX_END_LOCAL_FUNC1(return)

HXLINE( 393)				::String name = e->_hx_getString(2);
HXDLIN( 393)				 ::hscript::Expr fexpr = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 393)				::Array< ::Dynamic> params1 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 394)				 ::haxe::ds::StringMap capturedLocals = this->duplicate(this->locals);
HXLINE( 395)				 ::hscript::Interp me = hx::ObjectPtr<OBJ_>(this);
HXLINE( 396)				bool hasOpt = false;
HXDLIN( 396)				int minParams = (int)0;
HXLINE( 397)				{
HXLINE( 397)					int _g2 = (int)0;
HXDLIN( 397)					while((_g2 < params1->length)){
HXLINE( 397)						 ::Dynamic p1 = params1->__get(_g2);
HXDLIN( 397)						_g2 = (_g2 + (int)1);
HXLINE( 398)						if (( (bool)(p1->__Field(HX_("opt",33,9c,54,00),hx::paccDynamic)) )) {
HXLINE( 399)							hasOpt = true;
            						}
            						else {
HXLINE( 401)							minParams = (minParams + (int)1);
            						}
            					}
            				}
HXLINE( 402)				 ::Dynamic f3 =  ::Dynamic(new _hx_Closure_0(name,fexpr,_gthis,minParams,me,capturedLocals,params1));
HXLINE( 448)				 ::Dynamic f4 = ::Reflect_obj::makeVarArgs(f3);
HXLINE( 449)				if (hx::IsNotNull( name )) {
HXLINE( 450)					if ((this->depth == (int)0)) {
HXLINE( 452)						::haxe::IMap_obj::set(this->variables,name,f4);
            					}
            					else {
HXLINE( 455)						::Array< ::Dynamic> _hx_tmp1 = this->declared;
HXDLIN( 455)						 ::Dynamic _hx_tmp2 = ::haxe::IMap_obj::get(this->locals,name);
HXDLIN( 455)						_hx_tmp1->push( ::Dynamic(hx::Anon_obj::Create(2)
            							->setFixed(0,HX_("n",6e,00,00,00),name)
            							->setFixed(1,HX_("old",a7,98,54,00),_hx_tmp2)));
HXLINE( 456)						 ::Dynamic ref =  ::Dynamic(hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("r",72,00,00,00),f4));
HXLINE( 457)						::haxe::IMap_obj::set(this->locals,name,ref);
HXLINE( 458)						capturedLocals->set(name,ref);
            					}
            				}
HXLINE( 461)				return f4;
            			}
            			break;
            			case (int)15: {
HXLINE( 390)				 ::hscript::Expr e16 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 391)				 ::Dynamic _hx_tmp3;
HXDLIN( 391)				if (hx::IsNull( e16 )) {
HXLINE( 391)					_hx_tmp3 = null();
            				}
            				else {
HXLINE( 391)					_hx_tmp3 = this->expr(e16);
            				}
HXDLIN( 391)				this->returnValue = _hx_tmp3;
HXLINE( 392)				HX_STACK_DO_THROW(::hscript::_Interp::Stop_obj::SReturn_dyn());
            			}
            			break;
            			case (int)16: {
HXLINE( 504)				 ::hscript::Expr index = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 504)				 ::hscript::Expr e17 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 505)				 ::Dynamic arr = this->expr(e17);
HXLINE( 506)				 ::Dynamic index1 = this->expr(index);
HXLINE( 507)				if (::Std_obj::is(arr,hx::ClassOf< ::haxe::IMap >())) {
HXLINE( 508)					return ::haxe::IMap_obj::get(arr,index1);
            				}
            				else {
HXLINE( 511)					return arr->__GetItem(( (int)(index1) ));
            				}
            			}
            			break;
            			case (int)17: {
HXLINE( 462)				::Array< ::Dynamic> arr1 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 463)				bool _hx_tmp4;
HXDLIN( 463)				if ((arr1->length > (int)0)) {
HXLINE( 463)					 ::hscript::Expr _g5 = arr1->__get((int)0).StaticCast<  ::hscript::Expr >();
HXDLIN( 463)					if ((_hx_getEnumValueIndex(_g5) == (int)6)) {
HXLINE( 463)						if ((_g5->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXLINE( 464)					bool isAllString = true;
HXLINE( 465)					bool isAllInt = true;
HXLINE( 466)					bool isAllObject = true;
HXLINE( 467)					bool isAllEnum = true;
HXLINE( 468)					::cpp::VirtualArray keys = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 469)					::cpp::VirtualArray values = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 470)					{
HXLINE( 470)						int _g12 = (int)0;
HXDLIN( 470)						while((_g12 < arr1->length)){
HXLINE( 470)							 ::hscript::Expr e18 = arr1->__get(_g12).StaticCast<  ::hscript::Expr >();
HXDLIN( 470)							_g12 = (_g12 + (int)1);
HXLINE( 471)							if ((_hx_getEnumValueIndex(e18) == (int)6)) {
HXLINE( 471)								if ((e18->_hx_getString(0) == HX_("=>",61,35,00,00))) {
HXLINE( 472)									 ::hscript::Expr eValue = e18->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 472)									 ::hscript::Expr eKey = e18->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 472)									{
HXLINE( 473)										 ::Dynamic key = this->expr(eKey);
HXLINE( 474)										 ::Dynamic value1 = this->expr(eValue);
HXLINE( 475)										if (isAllString) {
HXLINE( 475)											isAllString = ::Std_obj::is(key,hx::ClassOf< ::String >());
            										}
            										else {
HXLINE( 475)											isAllString = false;
            										}
HXLINE( 476)										if (isAllInt) {
HXLINE( 476)											isAllInt = ::Std_obj::is(key,hx::ClassOf< int >());
            										}
            										else {
HXLINE( 476)											isAllInt = false;
            										}
HXLINE( 477)										if (isAllObject) {
HXLINE( 477)											isAllObject = ::Reflect_obj::isObject(key);
            										}
            										else {
HXLINE( 477)											isAllObject = false;
            										}
HXLINE( 478)										if (isAllEnum) {
HXLINE( 478)											isAllEnum = ::Reflect_obj::isEnumValue(key);
            										}
            										else {
HXLINE( 478)											isAllEnum = false;
            										}
HXLINE( 479)										keys->push(key);
HXLINE( 480)										values->push(value1);
            									}
            								}
            								else {
HXLINE( 482)									HX_STACK_DO_THROW(HX_("=> expected",17,e5,65,e5));
            								}
            							}
            							else {
HXLINE( 482)								HX_STACK_DO_THROW(HX_("=> expected",17,e5,65,e5));
...
HXLINE( 485)					 ::Dynamic map;
HXLINE( 486)					if (isAllInt) {
HXLINE( 485)						map =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            					}
            					else {
HXLINE( 487)						if (isAllString) {
HXLINE( 485)							map =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            						}
            						else {
HXLINE( 488)							if (isAllEnum) {
HXLINE( 485)								map =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
            							}
            							else {
HXLINE( 489)								if (isAllObject) {
HXLINE( 485)									map =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            								}
            								else {
HXLINE( 490)									HX_STACK_DO_THROW(HX_("Inconsistent key types",af,4f,50,a9));
            								}
            							}
            						}
            					}
HXLINE( 492)					{
HXLINE( 492)						int _g21 = (int)0;
HXDLIN( 492)						int _g13 = keys->get_length();
HXDLIN( 492)						while((_g21 < _g13)){
HXLINE( 492)							_g21 = (_g21 + (int)1);
HXDLIN( 492)							int n1 = (_g21 - (int)1);
HXLINE( 493)							::Dynamic _hx_tmp5 = map;
HXDLIN( 493)							::haxe::IMap_obj::set(_hx_tmp5,keys->__get(n1),values->__get(n1));
            						}
            					}
HXLINE( 495)					return map;
            				}
            				else {
HXLINE( 498)					::cpp::VirtualArray a = ::cpp::VirtualArray_obj::__new();
HXLINE( 499)					{
HXLINE( 499)						int _g14 = (int)0;
HXDLIN( 499)						while((_g14 < arr1->length)){
HXLINE( 499)							 ::hscript::Expr e19 = arr1->__get(_g14).StaticCast<  ::hscript::Expr >();
HXDLIN( 499)							_g14 = (_g14 + (int)1);
HXLINE( 500)							a->push(this->expr(e19));
            						}
            					}
HXLINE( 502)					return a;
            				}
            			...
            			break;
            			case (int)18: {
HXLINE( 513)				::Array< ::Dynamic> params2 = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 513)				::String cl = e->_hx_getString(0);
HXLINE( 514)				::cpp::VirtualArray a1 = ::cpp::VirtualArray_obj::__new();
HXLINE( 515)				{
HXLINE( 515)					int _g6 = (int)0;
HXDLIN( 515)					while((_g6 < params2->length)){
HXLINE( 515)						 ::hscript::Expr e20 = params2->__get(_g6).StaticCast<  ::hscript::Expr >();
HXDLIN( 515)						_g6 = (_g6 + (int)1);
HXLINE( 516)						a1->push(this->expr(e20));
            					}
            				}
HXLINE( 517)				return this->cnew(cl,a1);
            			}
            			break;
            			case (int)19: {
HXLINE( 518)				 ::hscript::Expr e23 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 519)				HX_STACK_DO_THROW(this->expr(e23));
            			}
            			break;
            			case (int)20: {
HXLINE( 520)				 ::hscript::Expr ecatch = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXDLIN( 520)				::String n2 = e->_hx_getString(1);
HXDLIN( 520)				 ::hscript::Expr e24 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 521)				int old2 = this->declared->length;
HXLINE( 522)				bool oldTry = this->inTry;
HXLINE( 523)				try {
            					HX_STACK_CATCHABLE( ::hscript::_Interp::Stop, 0);
            					HX_STACK_CATCHABLE( ::Dynamic, 1);
HXLINE( 524)					this->inTry = true;
HXLINE( 525)					 ::Dynamic v3 = this->expr(e24);
HXLINE( 526)					this->restore(old2);
HXLINE( 527)					this->inTry = oldTry;
HXLINE( 528)					return v3;
            				}
            				catch( ::Dynamic _hx_e){
            					if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 530)						this->inTry = oldTry;
HXLINE( 531)						HX_STACK_DO_THROW(err);
            					}
...
HXLINE( 537)						::Array< ::Dynamic> _hx_tmp6 = this->declared;
HXDLIN( 537)						_hx_tmp6->push( ::Dynamic(hx::Anon_obj::Create(2)
            							->setFixed(0,HX_("n",6e,00,00,00),n2)
            							->setFixed(1,HX_("old",a7,98,54,00),::haxe::IMap_obj::get(this->locals,n2))));
HXLINE( 538)						::haxe::IMap_obj::set(this->locals,n2, ::Dynamic(hx::Anon_obj::Create(1)
            							->setFixed(0,HX_("r",72,00,00,00),err1)));
HXLINE( 539)						 ::Dynamic v4 = this->expr(ecatch);
HXLINE( 540)						this->restore(old2);
HXLINE( 541)						return v4;
            					}
            					else {
            						HX_STACK_DO_THROW(_hx_e);
            					}
            			...
            			break;
            			case (int)21: {
HXLINE( 543)				::Array< ::Dynamic> fl = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
HXLINE( 544)				 ::Dynamic o =  ::Dynamic(hx::Anon_obj::Create(0));
HXLINE( 545)				{
HXLINE( 545)					int _g7 = (int)0;
HXDLIN( 545)					while((_g7 < fl->length)){
HXLINE( 545)						 ::Dynamic f5 = fl->__get(_g7);
HXDLIN( 545)						_g7 = (_g7 + (int)1);
HXLINE( 546)						::String f6 = ( (::String)(f5->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)) );
HXDLIN( 546)						this->set(o,f6,this->expr(f5->__Field(HX_("e",65,00,00,00),hx::paccDynamic)));
            					}
            				}
HXLINE( 547)				return o;
            			}
            			break;
            			case (int)22: {
HXLINE( 548)				 ::hscript::Expr e25 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 548)				 ::hscript::Expr e110 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 548)				 ::hscript::Expr econd2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 549)				if (hx::IsEq( this->expr(econd2),true )) {
HXLINE( 549)					return this->expr(e110);
            				}
            				else {
HXLINE( 549)					return this->expr(e25);
            				}
            			}
            			break;
            			case (int)23: {
HXLINE( 550)				 ::hscript::Expr def = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 550)				::Array< ::Dynamic> cases = e->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 550)				 ::hscript::Expr e26 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 551)				 ::Dynamic val = this->expr(e26);
HXLINE( 552)				bool match = false;
HXLINE( 553)				{
HXLINE( 553)					int _g8 = (int)0;
HXDLIN( 553)					while((_g8 < cases->length)){
HXLINE( 553)						 ::Dynamic c1 = cases->__get(_g8);
HXDLIN( 553)						_g8 = (_g8 + (int)1);
HXLINE( 554)						{
HXLINE( 554)							int _g15 = (int)0;
HXDLIN( 554)							::Array< ::Dynamic> _g22 = ( (::Array< ::Dynamic>)(c1->__Field(HX_("values",e2,03,b7,4f),hx::paccDynamic)) );
HXDLIN( 554)							while((_g15 < _g22->length)){
HXLINE( 554)								 ::hscript::Expr v5 = _g22->__get(_g15).StaticCast<  ::hscript::Expr >();
HXDLIN( 554)								_g15 = (_g15 + (int)1);
HXLINE( 555)								if (hx::IsEq( this->expr(v5),val )) {
HXLINE( 556)									match = true;
HXLINE( 557)									goto _hx_goto_61;
            								}
            							}
            							_hx_goto_61:;
            						}
HXLINE( 559)						if (match) {
HXLINE( 560)							val = this->expr(c1->__Field(HX_("expr",35,fd,1d,43),hx::paccDynamic));
HXLINE( 561)							goto _hx_goto_60;
            						}
            					}
            					_hx_goto_60:;
            				}
HXLINE( 564)				if (!(match)) {
HXLINE( 565)					if (hx::IsNull( def )) {
HXLINE( 565)						val = null();
            					}
            					else {
HXLINE( 565)						val = this->expr(def);
            					}
            				}
HXLINE( 566)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 380)				 ::hscript::Expr e27 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 380)				 ::hscript::Expr econd3 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 381)				this->doWhileLoop(econd3,e27);
HXLINE( 382)				return null();
            			}
            			break;
            			case (int)25: {
HXLINE( 567)				 ::hscript::Expr e28 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 568)				return this->expr(e28);
            			}
            			break;
            			case (int)26: {
HXLINE( 569)				 ::hscript::Expr e29 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 570)				return this->expr(e29);
            			}
            			break;
            		}
...
void Interp_obj::doWhileLoop( ::hscript::Expr econd, ::hscript::Expr e){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_575_doWhileLoop)
HXLINE( 576)		int old = this->declared->length;
HXLINE( 577)		while(true){
HXLINE( 578)			try {
            				HX_STACK_CATCHABLE( ::hscript::_Interp::Stop, 0);
HXLINE( 579)				this->expr(e);
            			}
            			catch( ::Dynamic _hx_e){
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 581)					switch((int)(_hx_getEnumValueIndex(err))){
            						case (int)0: {
HXLINE( 583)							goto _hx_goto_64;
            						}
            						break;
            						case (int)1: {
            						}
            						break;
            						case (int)2: {
HXLINE( 584)							HX_STACK_DO_THROW(err);
            						}
            						break;
            					}
            				}
...
HXLINE( 577)			if (!(hx::IsEq( this->expr(econd),true ))) {
HXLINE( 577)				goto _hx_goto_64;
            			}
            		}
            		_hx_goto_64:;
HXLINE( 589)		this->restore(old);
            	}
...
void Interp_obj::whileLoop( ::hscript::Expr econd, ::hscript::Expr e){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_592_whileLoop)
HXLINE( 593)		int old = this->declared->length;
HXLINE( 594)		while(hx::IsEq( this->expr(econd),true )){
HXLINE( 595)			try {
            				HX_STACK_CATCHABLE( ::hscript::_Interp::Stop, 0);
HXLINE( 596)				this->expr(e);
            			}
            			catch( ::Dynamic _hx_e){
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 598)					switch((int)(_hx_getEnumValueIndex(err))){
            						case (int)0: {
HXLINE( 600)							goto _hx_goto_66;
            						}
            						break;
            						case (int)1: {
            						}
            						break;
            						case (int)2: {
HXLINE( 601)							HX_STACK_DO_THROW(err);
            						}
            						break;
            					}
            				}
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,whileLoop,(void))
 ...
 ::Dynamic Interp_obj::makeIterator( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_608_makeIterator)
HXLINE( 612)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 612)			v = v->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
            		}
            		catch( ::Dynamic _hx_e){
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
...
HXDLIN( 614)		if (hx::IsNotNull(  ::Dynamic(v->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)) )) {
HXLINE( 614)			_hx_tmp = hx::IsNull(  ::Dynamic(v->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)) );
            		}
            		else {
HXLINE( 614)			_hx_tmp = true;
            		}
HXDLIN( 614)		if (_hx_tmp) {
HXLINE( 614)			 ::hscript::Error e1 = ::hscript::Error_obj::EInvalidIterator(v);
HXDLIN( 614)			HX_STACK_DO_THROW(e1);
            		}
HXLINE( 615)		return v;
            	}
...
void Interp_obj::forLoop(::String n, ::hscript::Expr it, ::hscript::Expr e){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_618_forLoop)
HXLINE( 619)		int old = this->declared->length;
HXLINE( 620)		::Array< ::Dynamic> _hx_tmp = this->declared;
HXDLIN( 620)		_hx_tmp->push( ::Dynamic(hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("n",6e,00,00,00),n)
            			->setFixed(1,HX_("old",a7,98,54,00),this->locals->get(n))));
HXLINE( 621)		 ::Dynamic it1 = this->makeIterator(this->expr(it));
HXLINE( 622)		while(( (bool)(it1->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 623)			{
HXLINE( 623)				::Dynamic this1 = this->locals;
HXDLIN( 623)				( ( ::haxe::ds::StringMap)(this1) )->set(n, ::Dynamic(hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("r",72,00,00,00),it1->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)())));
            			}
HXLINE( 624)			try {
            				HX_STACK_CATCHABLE( ::hscript::_Interp::Stop, 0);
HXLINE( 625)				this->expr(e);
            			}
            			catch( ::Dynamic _hx_e){
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 627)					switch((int)(_hx_getEnumValueIndex(err))){
            						case (int)0: {
HXLINE( 629)							goto _hx_goto_69;
            						}
            						break;
            						case (int)1: {
            						}
            						break;
            						case (int)2: {
HXLINE( 630)							HX_STACK_DO_THROW(err);
            						}
            						break;
            					}
            				}
...
bool Interp_obj::isMap( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_638_isMap)
HXLINE( 638)		return ::Std_obj::is(o,hx::ClassOf< ::haxe::IMap >());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Interp_obj,isMap,return )
 ...
 ::Dynamic Interp_obj::getMapValue( ::Dynamic map, ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_642_getMapValue)
HXLINE( 642)		return ::haxe::IMap_obj::get(map,key);
            	}
...
void Interp_obj::setMapValue( ::Dynamic map, ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_646_setMapValue)
HXLINE( 646)		::haxe::IMap_obj::set(map,key,value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,setMapValue,(void))
 ...
 ::Dynamic Interp_obj::get( ::Dynamic o,::String f){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_649_get)
HXLINE( 650)		if (hx::IsNull( o )) {
HXLINE( 650)			 ::hscript::Error e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 650)			HX_STACK_DO_THROW(e);
            		}
HXLINE( 651)		return ::Reflect_obj::getProperty(o,f);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(Interp_obj,get,return )
 ...
 ::Dynamic Interp_obj::set( ::Dynamic o,::String f, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_665_set)
HXLINE( 666)		if (hx::IsNull( o )) {
HXLINE( 666)			 ::hscript::Error e = ::hscript::Error_obj::EInvalidAccess(f);
HXDLIN( 666)			HX_STACK_DO_THROW(e);
            		}
HXLINE( 667)		::Reflect_obj::setProperty(o,f,v);
HXLINE( 668)		return v;
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,set,return )
 ...
 ::Dynamic Interp_obj::fcall( ::Dynamic o,::String f,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_672_fcall)
HXLINE( 672)		return this->call(o,this->get(o,f),args);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,fcall,return )
 ...
 ::Dynamic Interp_obj::call( ::Dynamic o, ::Dynamic f,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_676_call)
HXLINE( 676)		return ::Reflect_obj::callMethod(o,f,args);
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(Interp_obj,call,return )
 ...
 ::Dynamic Interp_obj::cnew(::String cl,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_f37559d470356c9e_679_cnew)
HXLINE( 680)		hx::Class c = ::Type_obj::resolveClass(cl);
HXLINE( 681)		if (hx::IsNull( c )) {
HXLINE( 681)			c = this->resolve(cl);
            		}
HXLINE( 682)		return ::Type_obj::createInstance(c,args);
            	}
